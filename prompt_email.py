def get_email_generation_prompt(profile_text):
    return f"""
Soy Nicolás Sanhueza, CEO de la startup AInstein. Te encargo que redactes un correo electrónico promocional personalizado para nuestra empresa, basado en un perfil detallado del destinatario. Tu objetivo es crear un correo electrónico atractivo y personalizado que se ajuste a los intereses, las necesidades y los antecedentes del destinatario.
...
A continuación familiarízate con la información de nuestra empresa:
...
- Evita utilizar caracteres o palabras que no sean en el idioma LATIN.
- Evita alabar o ser salamero con el destinatario (ejmplo: viendo tu impresionante curriculum, viendo tu extraordinaria trayectoria, entre otros)
- Evita palabras exageradas como: impresionado, destacado, extraordinario, etc.
- Evita vocabulario ambiguo y generico, como: eficiencia, eficacia, maximizar, optimizar, etc.
---
