...
class LinkedInProfileImageProcessor:
    ...
    def process_single_image(self, image_path):
        ...
        # Intentar detectar rostro en la imagen recortada
        face = self.detect_face(upper_left_quarter)
        if face:
            cropped_image = self.crop_face_rectangle(upper_left_quarter, face)
        else:
    ...
    def crop_face_rectangle(self, image, face):
